...
class Dots extends StatelessWidget {
  ...
  Dots(this._currentIndex, this._pageCount, this._dots, this._indicatorDecoration);
  ...
  Widget build(BuildContext context) {
   switch (_dots) {
      case 0: return Row(children: _buildPageIndicators());
      case 1: return ClipRRect(
        borderRadius: BorderRadius.circular(8.0),
        child: LinearProgressIndicator(
          backgroundColor: _indicatorDecoration.inactive,
          valueColor: AlwaysStoppedAnimation<Color>(_indicatorDecoration.active),
          value: (1 / _pageCount) * (_currentIndex + 1)
        )
      );
      case 2: return Row(children: _buildPageIndicators());
      case 3: return Row(children: _buildPageIndicators());
      default: return Row(children: _buildPageIndicators());
    }
  }
}